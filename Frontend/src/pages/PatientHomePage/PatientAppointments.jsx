...
function PatientAppointments() {
  ...
  const fetchAppointments = async () => {
    try {
      const response = await axios.get("/api/v1/user/getPatientAppointments");
  ...
  const handleCancelAppointment = async (appointmentId) => {
    ...
    try {
      const response = await axios.put(`/api/v1/user/appointments/${appointmentId}/cancel`);
      if (response.data.success) {
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 mb-1">
                        {appointment.speciality || "General Medicine"}
                      </p>
                      <p className="text-sm text-gray-500 mb-3">
                        {appointment.clinic || "Clinic information not available"}
                      </p>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600">
                            {appointment.doctorPhone || "Not available"}
                          </p>
                        </div>
                      </div>
                    </div>
