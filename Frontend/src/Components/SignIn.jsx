        ...
        <div>
          <form onSubmit={onSubmit} action="">
            ...
            <div className="flex  mt-5 justify-between items-center">
              ...
              <div>
                <a href="/" className="text-indigo-300 hover:text-indigo-400 transition-all duration-300 ease-in-out">
                  Forgot Password?
                </a>
              </div>
            </div>
          ...
          <div className="mt-5 text-white">
            ...
            <a href="/SignUp" className="text-indigo-300 hover:text-indigo-400 transition-all duration-300 ease-in-out ml-2">
                   Create an Account
                </a>
          </div>
        </div>
