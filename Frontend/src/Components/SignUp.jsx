...
function SignUp() {
  return (
    <div>
      <div className="min-h-screen bg-[#112424] text-gray-900 flex justify-center">
        <div className="max-w-screen-xl m-0 sm:m-10 bg-[#1A3636] shadow sm:rounded-lg flex justify-center flex-1">
          <div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12  flex flex-col items-center">
              ...
              <div className="w-full flex-1 mt-8">
                <div className="flex flex-col items-center">
                  <button className="w-full font-bold shadow-sm rounded-full py-3 bg-indigo-100 text-gray-800 flex items-center justify-center hover:bg-indigo-300 transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline">
                ...
                <div className="flex mt-6 justify-center items-center">
                  ...
                  <h4 className="p-4 shrink-0 text-gray-300 tracking-tighter">or Sign in with Email</h4>
                  <div className="w-full h-[1px] bg-slate-300"></div>
                </div>
                ...
                <div className=" max-w-full">
                  <input
                    ...
                    placeholder="Email"
                  />
                  <div className="w-full h-fit grid grid-cols-3  mt-5">
                    <input
                  ...
                  <p className="mt-6 text-xs text-gray-400 text-center">
                    ...
                    <a
                      href="#"
                      className="border-b border-gray-300 border-dotted"
                    >
                      Terms of Service
                    </a>
                    and its
